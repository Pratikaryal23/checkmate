...
import Lawyerdata from "@/data/data.json"
...
const Card = () => {
  ...
  return (
    <div className='w-11/12 mx-auto py-3 flex flex-col gap-4'>
      <div>
        <h1 className='text-4xl font-bold font-serif text-[#082567]'>Lawyers Directory</h1>
            ...
            filteredLawyers.map((advocate) => (
              ...
              >
                ...
                <a
                  ...
                  className="block mt-4 bg-nepali-blue text-white text-center py-2 rounded-lg font-medium hover:bg-blue-800 transition"
                >
                  💬 Chat on WhatsApp
                </a>
              </div>
